((Scratch) => {
    ...
    if (typeof vm.runtime !== "undefined" && typeof vm.runtime.platform !== "undefined" && typeof vm.runtime.platform.name !== "undefined") {
        ...
        titleBar.innerText = lang('aness6040debugger.windowText', 'Console') + ' @' + version + ' - ' + 
                    (Scratch.extensions.isElectraMod ? "Catnip Marketplace" : 
                    (Scratch.extensions.isPenguinMod ? "Catnip Marketplace" : "Scratch"));
    } else {
        titleBar.innerText = lang('aness6040debugger.windowText', 'Console') + ' @' + version;
    }
    ...
    addText({
        color: '#808080',
        message: `<h1>Marketplace Console</h1><br><h3>v${version}</h3><br>Originally by NOname (Based on turboWarp CN) and continued by Aness6040 (actual extension).<br><br>` + lang('aness6040debugger.tipForHelp', 'Type "help" to view > help.'),
    });
    ...
    class Aness6040debugger {
        getInfo() {
            ...
            blockIconURI: extIcon,
                ...
                name: lang('aness6040debugger.extName', 'Marketplace Console'),
                blocks: [
                    '---',
                    {
                        func: 'switchTheme',
